...
define('DIAFAN', 1);
define('ABSOLUTE_PATH', dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))).'/');
...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../../../../'.USERFILES.'/ufiles/thumbs/',
