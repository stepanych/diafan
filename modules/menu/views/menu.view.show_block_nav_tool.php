...
echo
'<nav class="nav-d nav-d_vertical nav-d_vertical_gray nav-d_template_toolbar">
	<div class="nav-d__inside">
		<button class="nav-d__burger burger-d" type="button" title="'.$this->diafan->_('Каталог', false).'">
			<span class="burger-d__name">'.$this->diafan->_('Каталог').'</span>
