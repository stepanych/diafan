...
echo
'<nav class="nav-d nav-d_horizontal nav-d_horizontal_laptop nav-d_horizontal_black nav-d_horizontal_laptop_black nav-d_main">
	<div class="nav-d__inside _box">
		<button class="nav-d__burger burger-d" type="button" title="'.$this->diafan->_('Каталог продукции', false).'">
			<span class="burger-d__icon icon-d"><span></span></span>
			<span class="burger-d__name">'.$this->diafan->_('Каталог продукции').'</span>
		</button>';
